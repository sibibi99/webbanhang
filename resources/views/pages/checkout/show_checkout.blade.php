					...
					<div class="bill-to">
						...
						<div class="form-one">
							<form method="POST">
								...
								@else 
									<input type="hidden" name="order_free" class="order_free" value="30000">
								@endif
						...
						<table class="table table-condensed">
							...
							<tbody>
								...
								<tr>
									...
									@if(Session::get('free'))
									<li>	
										<a class="cart_quantity_delete" href="{{url('/del-free')}}"><i class="fa fa-times"></i></a>
										Phí vận chuyển: <span>{{number_format(Session::get('free'),0,',','.')}}</span></li> 
